...
- Added support for Req 0.6.x while retaining compatibility with Req 0.5.x

## [0.3.4] - 2026-02-06

### Added
- Documentation for webhook handler error handling and retry behavior

## [0.3.3] - 2026-01-14

### Added
 - [Support billing portal sessions](https://github.com/enoonan/pin_stripe/pull/4) from [zvlasic](https://github.com/zvlasic). Thank you Zlatko! 🎉
